            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="row flex-between-center">
                        ...
                        <div class="col-auto">
                            <h4 class="fs-6 fw-normal text-warning"><?php echo money($stats['total'], 0); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="row flex-between-center">
                        ...
                        <div class="col-auto">
                            <h4 class="fs-6 fw-normal text-warning"><?php echo money($stats['this_month'], 0); ?></h4>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <table class="table table-hover mb-0 data-table fs-10" data-datatables='{"order": []}'>
                                ...
                                <?php foreach ($expenses as $e):
                                    ...
                                    <tr class="hover-actions-trigger btn-reveal-trigger hover-bg-100 cursor-pointer" onclick="viewExpense(<?php echo htmlspecialchars(json_encode($e)); ?>)">
                                        ...
                                        <td class="align-middle">
                                            <strong class="text-success"><?php echo money($e['amount']); ?></strong>
                                            <?php if ($isItemCat && !empty($e['cost_per_unit']) && !empty($e['quantity']) && $e['quantity'] > 1): ?>
                                                <p class="mb-0 text-muted" style="font-size:0.72rem;">@ <?php echo money($e['cost_per_unit']); ?>/unit</p>
                                            <?php endif; ?>
                                        </td>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-3" id="add_amount_group">
                                <label class="form-label">Amount (<?php echo currencySymbol(); ?>) <span class="text-danger">*</span></label>
        ...
        function viewExpense(e) {
            ...
            <div class="row g-3 mb-3">
                ...
                <div class="col-sm-6">
                    <div class="p-3 rounded bg-success bg-opacity-10">
                        ...
                        <p class="mb-0 fw-bold text-success fs-5">${currencyPrefix}${parseFloat(e.amount || 0).toLocaleString('en-KE', {minimumFractionDigits: 2})}</p>
                    </div>
                </div>`;
            ...
            <div class="row g-3 mb-3">`;
                ...
                <div class="col-sm-6 col-md-4">
                    ...
                    <p class="mb-0 fw-semibold">${currencyPrefix}${parseFloat(e.cost_per_unit).toLocaleString('en-KE', {minimumFractionDigits: 2})}</p>
                </div>`;
                }
